...
const StatisticsGrid = () => {
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="p-4 flex flex-col items-center text-center animate-pulse"
          >
  ...
  if ((error || !statistics) && !isLoading) {
    ...
    return (
      <div className="flex flex-wrap justify-center gap-10 max-w-4xl mx-auto mb-12">
        ...
        <div className="p-4 flex flex-col items-center text-center flex-1 min-w-[150px]">
          <div className="text-4xl font-bold text-primary-600 mb-2 flex items-center">
            <span className="material-icons mr-2 text-3xl">
              chalkboard_teacher
            </span>
            50+
          </div>
  ...
  return (
    // <div className="flex flex-wrap justify-center gap-10 max-w-4xl mx-auto mb-12">
    // <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 max-w-4xl mx-auto mb-12">
    <div className="flex flex-wrap justify-evenly gap-10 w-full mb-12">
        ...
        ? // Map items in explicit predefined order
          orderedItems.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="p-4 flex flex-col items-center text-center flex-1 min-w-[150px]"
              >
                <div className="text-4xl font-bold text-primary-600 mb-2 flex items-center">
                  <span className="material-icons mr-2 text-3xl">
                    {item.icon}
